...
<title>Easy and convenient for everyone Cosmetics Compare 메인페이지</title>
</head>
<body>
	...
	<nav class="navbar navbar-default">
		<div class="btn-primary form-control" style="text-align:center;"><a href="main.jsp" style="color:white; text-decoration: none;
